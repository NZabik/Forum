...
require_once "../controllers/categ2controller.php";
?>
...
<h1 id="register-title">Les accessoires</h1>

<form action="../controllers/categ2controller.php" method="post" id="formulaire">
