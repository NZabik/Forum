...
$req = "SELECT sujet.Id_SUJET,sujet.Nom_sujet,sujet.date,utilisateur.Nom,utilisateur.Prénom from sujet join utilisateur on utilisateur.Id_UTILISATEUR = sujet.Id_UTILISATEUR WHERE Id_CATEGORIE = 1 order by Id_SUJET";
